...
public class Assignment_4_2{
    ...
    public Assignment_4_2() {}
    
    public Assignment_4_2(String brand, String model, int year, double price, boolean isSold) {
        this.brand = brand;
        this.model = model;
        this.year = year;
        this.price = price;
...
class Main {
    public static void main(String[] args) {
        Assignment_4_2 car = new Assignment_4_2(); 
        car.setBrand("Toyota");
        car.setModel("Raize");
        car.setYear(2021);
       ...
       Assignment_4_2 car2 = new Assignment_4_2("Honda", "Civic", 2022, 600.000, true);
